...
if navigation_tab == 'Labelizer':
    ...
    main_file = pd.read_csv('/Users/apple/Documents/work_DFA/Labelizer/main_file_error_v4_windx_2k.csv',sep = '\t') # curated dataframe for only actual , pred class as file name
    ...
    with st.container():
        ...
        def first_page(idx):
            ...
            # a = rms_df.rms_raw_vec[0]
            # a[:,1]



            #VA_VB_VC
            # raw_format = main_file.rms_raw[idx]
            # print(raw_format)
            # norm_format = main_file.rms[idx]
            # print(norm_format)
            indx = main_file.indx[idx]
            y1 = x_raw[indx,:,0]
            y2 = x_raw[indx,:,1]
            y3 = x_raw[indx,:,2]  
